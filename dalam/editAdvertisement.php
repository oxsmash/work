...
ob_start();
session_start();
$judulHalaman="EDIT Advertisement";
$fileIndex="";
$fileSearch="";
...
if($act=="edit")
{	
	$queryString = "select * from cni_streamer where id='3'";
...
if($aksi=="1")
{
	...
	if(strlen($pIsi) < 20) $strError=$strError."<li> Belum mengisi isi advertisement.";
	...
	if(strlen($strError) < 1)
	{
		...
		$query = "UPDATE cni_streamer set isi='".addslashes($pIsi)."',status='$vStatus' where id='3'";
...
?>
				<!--sisi kanan mulai-->
				<br />
				&nbsp;&nbsp;<span class="judul_menu">Edit Advertisement ::</span>
				<br />
				<br />
				<?php
