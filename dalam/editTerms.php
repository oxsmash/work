...
ob_start();
session_start();
$judulHalaman="EDIT Terms & Condition";
$fileIndex="";
$fileSearch="";
...
if($act=="edit")
{	
	$queryString = "select * from cni_streamer where id='4'";
...
if($aksi=="1")
{
	...
	if(strlen($pIsi) < 20) $strError=$strError."<li> Belum mengisi isi terms & conditions.";
	...
	if(strlen($strError) < 1)
	{
		...
		$query = "UPDATE cni_streamer set isi='".addslashes($pIsi)."',status='$vStatus' where id='4'";
...
?>
				<!--sisi kanan mulai-->
				<br />
				&nbsp;&nbsp;<span class="judul_menu">Edit Terms & Conditions ::</span>
				<br />
				<br />
				<?php
