...
<tr><td>Kata Kunci</td><td>:</td><td><input type="text" name="katakunci" value="<?=$katakunci?>">
    ...
    <option value="8" <?=($letakBanner == "8") ? "selected" : "" ?>>Player</option>
	</select>
...
?>
				...
				<tr bgcolor="#FFFFFF" onMouseOver="this.style.background='#ebebeb'" onMouseOut="this.style.background='#FFFFFF'">
				   ...
				   {
				   	echo '<a href="listBanner.php?act=hapus&id='.$rs[banner_id].'&status=1&PageNo='.$PageNo.'"><img src="../images/on3.gif" alt="Active" border="0"></a>&nbsp;';
				   	echo '<img src="../images/off2.gif" border="0" alt="Set Inactive">';
				   }
				   else
				   {
				   	echo '<img src="../images/on2.gif" alt="Active">&nbsp;';
				   	echo '<a href="listBanner.php?act=hapus&id='.$rs[banner_id].'&status=0&PageNo='.$PageNo.'"><img src="../images/off3.gif" border="0" alt="Set Inactive"></a>';
				   }
				   ?></td>
				</tr>
				<?
