...
if($act=="edit")
{	
	$queryString = "select * from cni_streamer where status = '1' and id='1'";
...
if($aksi=="1")
{
	...
	if(strlen($strError) < 1)
	{
		...
		$query = "UPDATE cni_streamer set isi='".addslashes($pIsi)."'where id='1'";
...
?>
				<!--sisi kanan mulai-->
				<br />
				&nbsp;&nbsp;<span class="judul_menu">Edit Welcome ::</span>
				<br />
				<br />
				<?php
