...
function wp_open_image_window(obj) {
	...
	if (imageNode) {
		if ((imageNode.getAttribute('name')) && (imageNode.src.search(wp_directory+"images/bookmark_symbol.gif") != -1)) {
			...
			if (!iborder) iborder = '';
			szURL= wp_directory + 'imageoptions.php' + '?thumbnails='+obj.thumbnails+'&image=' + escape(image) +'&width=' + width +'&height=' + height + '&alt=' + escape(alt) + '&align=' + align + '&mtop=' + mtop + '&mbottom=' + mbottom + '&mleft=' + mleft + '&mright=' + mright + '&border=' + iborder + "&lang="+obj.instance_lang 
		}
	} else {
