 ...
 *                              -------------------
 *  author      : Chris Bolt
 *  copyright   : (C) Chris Bolt 2006. All Rights Reserved
 *  version     : 2.2.10
...
$path_folder="/1300_jogjastreamers/work";
//$path_folder="";

define('WP_WEB_DIRECTORY', $path_folder.'/editor_files/');
...
define('IMAGE_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].$path_folder.'/images/upload/');
...
define('IMAGE_WEB_DIRECTORY', 'http://'.$_SERVER['HTTP_HOST'].$path_folder.'/images/upload/');
...
define('DOCUMENT_FILE_DIRECTORY',$_SERVER['DOCUMENT_ROOT'].$path_folder.'/images/download/');
...
define('DOCUMENT_WEB_DIRECTORY', 'http://'.$_SERVER['HTTP_HOST'].$path_folder.'/images/download/');
...
$max_file_size = 150000;                         // maximum allowed filesize for uploaded images upload in bytes
