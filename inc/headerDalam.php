				...
				<tr><!--Body-->
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<table width="160" cellpadding="0" cellspacing="0" border="0">
							<tr><td width="164"><img src="images/frameAtas.gif" width="164" height="9"></td>
							<tr><td width="164" height="21" background="images/streaming-bg.gif">
							<table width="153" height="21" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#9D0A0E">
                                  <tr>
                                    <td width="76"><img src="images/tulisanStreaming.gif" width="76" height="21"></td>
                                    <td width="77" align="center"><img src="images/streamanim.gif" width="46" height="14"></td>
                                  </tr>
                                </table>							
							</td>
							</tr>
							...
							<a href="download/wmpfirefoxplugin.exe">WMPPlugin for Firefox</a><br />
							<a href="download/mp3PROAudioDecoder.exe">MP3ProPlugin for WinAmp</a><br />
							</td></tr>
