...
$stU=0;
$Login = "";
$Query = "SELECT ".tabel_user.".*,".tabel_user_detail.".* FROM ".tabel_user.",".tabel_user_detail." WHERE ".tabel_user.".user_name ='".addslashes($userMasuk)."' AND ".tabel_user.".level_id = 30  AND ".tabel_user_detail.".user_id=".tabel_user.".user_id";
//echo $Query;
