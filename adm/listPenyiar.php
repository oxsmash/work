...
?>
	...
	<tr bgcolor="#ebebeb" onMouseOver="this.style.background='#ffffff'" onMouseOut="this.style.background='#ebebeb'">
		...
		<td valign="top" align="center">
		   ...
		   if($rs['status']=="0")
		   {
		   	echo '<a href="listPenyiar.php?act=hapus&id='.$rs['id_penyiar'].'&status=1"><img src="../images/status_1_b.gif" alt="Active" border="0"></a>&nbsp;';
		   	echo '<img src="../images/status_0_b.gif" border="0" alt="Set Inactive">';				   	
		   }
		   else
		   {
		   	echo '<img src="../images/status_1.gif" alt="Active">&nbsp;';
		   	echo '<a href="listPenyiar.php?act=hapus&id='.$rs['id_penyiar'].'&status=0"><img src="../images/status_0.gif" border="0" alt="Set Inactive"></a>';
		   }
		   ?>
		</td>
		<td valign="top" align="center">
			<a href="listPenyiar.php?act=reset&id=<?=$rs['id_penyiar']?>"><img src="../images/status_1_b.gif" alt="Reset Password" border="0"></a>
		</td>
	</tr>
	<?
	}
