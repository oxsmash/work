...
?>
	...
	<tr bgcolor="#ebebeb" onMouseOver="this.style.background='#ffffff'" onMouseOut="this.style.background='#ebebeb'">
	   ...
	   {
	   	echo '<a href="listBerita.php?act=hapus&id='.$rs[berita_id].'&status=1"><img src="../images/status_1_b.gif" alt="Active" border="0"></a>&nbsp;';
	   	echo '<img src="../images/status_0_b.gif" border="0" alt="Set Inactive">';				   	
	   }
	   else
	   {
	   	echo '<img src="../images/status_1.gif" alt="Active">&nbsp;';
	   	echo '<a href="listBerita.php?act=hapus&id='.$rs[berita_id].'&status=0"><img src="../images/status_0.gif" border="0" alt="Set Inactive"></a>';
	   }
	   ?></td>
	</tr>
	<?
