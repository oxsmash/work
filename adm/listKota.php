...
?>
	...
	<tr bgcolor="#BBBABA">
				...
				<tr bgcolor="#FFFFFF" onMouseOver="this.style.background='#ebebeb'" onMouseOut="this.style.background='#FFFFFF'">
				   ...
				   if($rs[status]=="0")
				   {
				   	echo '<a href="listKota.php?act=hapus&id='.$rs[id_kota].'&status=1"><img src="../images/status_1_b.gif" alt="Active" border="0"></a>&nbsp;';
				   	echo '<img src="../images/status_0_b.gif" border="0" alt="Set Inactive">';
				   }
				   else
				   {
				   	echo '<img src="../images/status_1.gif" alt="Active">&nbsp;';
				   	echo '<a href="listKota.php?act=hapus&id='.$rs[id_kota].'&status=0"><img src="../images/status_0.gif" border="0" alt="Set Inactive"></a>';
				   }
				   ?></td>
				</tr>
				<?
