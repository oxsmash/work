...
if($_GET) {
	...
	if($_GET['waktu'] == 'bulan') {
		...
		for($k=1;$k<=date("t",mktime(0, 0, 0, $_GET['bulan'], 1,$_GET['tahun'] ));$k++) {
			...
			$strParam="caption=Jumlah Durasi Radio ".$brs2['nama']." Bulan ".$arrBulan[$_GET['bulan']]." Tahun ".$_GET['tahun'].";xAxisName=Bulan ".$arrBulan[$_GET['bulan']].";yAxisName=Jumlah Jam;decimals=0;rotateLabels=1;decimalPrecision=2;formatNumberScale=0;bgColor=EBEBEB;";
			
			$strTmp1000 = "listStatWaktu.php?date1=".$_GET['tahun']."-".$bln."-".$tgl."&waktu=jaman&slRadio=".$_GET['slRadio']."&cHidden=1";
		...
		for($k=0;$k<24;$k++) {
			...
			$strParam="caption=Jumlah Durasi Radio ".$brs2['nama']." Tanggal ".$arrTgl[2]." Bulan ".$arrBulan2[$arrTgl[1]]." Tahun ".$arrTgl[0].";xAxisName=24 Jam;yAxisName=Jumlah Jam;decimals=0;rotateLabels=1;decimalPrecision=2;formatNumberScale=0;bgColor=EBEBEB;";		
				
			$strTmp1005 = "listLogDurasi.php?katakunci=&jenis=jaman&cHidden=1&slRadio=".$_GET['slRadio']."&date1=".$arrTgl[2]."-".$arrTgl[1]."-".$arrTgl[0]."&date2=".$arrTgl[2]."-".$arrTgl[1]."-".$arrTgl[0]."&cSubmit=Cari";
	...
	for($k=1;$k<=date("t",mktime(0, 0, 0, date("n"), 1,date("Y") ));$k++) {
		...
		$strParam="caption=Jumlah Durasi Radio Bulan ".$arrBulan[date('n')]." Tahun ".date("Y").";xAxisName=Bulan ".$arrBulan[date('n')].";yAxisName=Jumlah Jam;decimals=0;rotateLabels=1;decimalPrecision=2;formatNumberScale=0;bgColor=EBEBEB;";
