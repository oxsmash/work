...
if($cHidden=="1"){
	...
	//if(!empty($_GET['slRadio'])) {
		...
		//$detQuery .= $detQuery . " AND id_radio = '".$_SESSION['SessionRadio']['radio']."' ";
	...
	$tmp = "date1=".$_GET['date1']."&date2=".$_GET['date2']."&cHidden=1";
	...
	$sqlview = "SELECT * FROM ".tabel_stat."
	...
	//echo $sqlview;
		...
		/*$sqlview = "SELECT nama,id_radio,referer,tgl,ip FROM ".tabel_radio." a,".tabel_stat." b 
				WHERE	a.radio_id = b.id_radio 
				AND		id_radio = '".$_SESSION['SessionRadio']['radio']."' 	
				ORDER BY tgl DESC ";*/
	...
	$sqlview = "SELECT * FROM ".tabel_stat." WHERE id_radio = '".$_SESSION['SessionRadio']['radio']."' 
					 ".$detQuery."
						  ORDER BY tgl DESC ";					
