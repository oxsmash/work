...
<tr><td>Radio</td><td>:</td><td><?=$_SESSION['SessionRadio']['nama_radio']?></td></tr>
...
if($_GET) {
	...
	if(!empty($_SESSION['SessionRadio']['mount_radio'])) {
	
		$cmd2 = "SELECT nama FROM radio WHERE mount = '/".$_SESSION['SessionRadio']['mount_radio']."' ";
	
		$hsl2 = mysql_query($cmd2);
		
		$brs2 = mysql_fetch_array($hsl2);
		
		$tmp30 = " AND		mount LIKE '/".$_SESSION['SessionRadio']['mount_radio']."%' ";
